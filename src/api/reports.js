...
export const getUploadReports = async ({
  ...
  date_released_from = '',
  date_released_to = '',
  date_received_cent_from = '',
  date_received_cent_to = '',
  user_uploader = '',
  ...
  if (date_received_cent_from) params.date_received_cent_from = date_received_cent_from;
  if (date_received_cent_to) params.date_received_cent_to = date_received_cent_to;
