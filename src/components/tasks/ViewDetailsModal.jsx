    ...
    >
      ...
      <div
        style={{
          ...
          fontSize: "0.875rem",
          minHeight: fullWidth ? "4rem" : "2.5rem",
    ...
    >
      ...
      >
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "2rem" }}>
          <VDSection title="🏢 Establishment Information" colors={colors}>
            <FieldGrid>
              <DisplayField
                label="Category"
          ...
          <VDSection title="💊 Product Information" colors={colors}>
            <FieldGrid>
              <DisplayField
                label="Brand Name"
          ...
          <VDSection title="🏭 Manufacturer Information" colors={colors}>
            <FieldGrid>
              <DisplayField
                label="Manufacturer"
          ...
          <VDSection title="🚢 Trader Information" colors={colors}>
            <FieldGrid>
              <DisplayField
                label="Trader"
          ...
          <VDSection title="📦 Repacker Information" colors={colors}>
            <FieldGrid>
              <DisplayField
                label="Repacker"
          ...
          <VDSection title="✈️ Importer Information" colors={colors}>
            <FieldGrid>
              <DisplayField
                label="Importer"
          ...
          <VDSection title="🚚 Distributor Information" colors={colors}>
            <FieldGrid>
              <DisplayField
                label="Distributor"
          ...
          <VDSection title="🔐 SECPA Information" colors={colors}>
            <FieldGrid>
              <DisplayField
                label="SECPA"
          ...
          <VDSection title="🎯 Decking Information" colors={colors}>
            <FieldGrid>
              <DisplayField
          ...
          <VDSection title="📤 Release Information" colors={colors}>
            <FieldGrid>
              <DisplayField
          ...
          <VDSection title="📜 CPR Condition" colors={colors}>
            <DisplayField
              label="CPR Condition"
          ...
          <VDSection title="📊 Metadata (Read-Only)" colors={colors}>
            <FieldGrid>
              <DisplayField
                label="Timeline (Days)"
