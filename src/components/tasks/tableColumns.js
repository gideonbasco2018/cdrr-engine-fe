...
export const tableColumns = [
  ...
  { key: "prodManuAdd",           label: "Manufacturer Address",       width: "180px" },
  { key: "prodManuCountry",       label: "Manufacturer Country",       width: "130px" },
  ...
  { key: "prodDistriCountry",     label: "Distributor Country",    width: "140px" },
  { key: "prodRepacker",          label: "Repacker",           width: "160px" },
  { key: "prodRepackerAdd",       label: "Repacker Address",   width: "200px" },
  { key: "prodRepackerCountry",   label: "Repacker Country",   width: "130px" },
...
export const COLUMN_DB_KEY_MAP = {
  ...
  // ── From application_logs — not sortable via DB_* but can sort by log field
