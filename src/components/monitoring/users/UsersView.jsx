...
if (typeof document !== "undefined" && !document.getElementById(USERS_ANIM_ID)) {
...
function GlassShimmerBox({ width = "100%", height = 14, radius = 6, darkMode, style: extra = {} }) {
...
function UsersViewSkeleton({ ui, darkMode }) {
  ...
  return (
    <div style={{
      ...
      padding: 16, borderRadius: 18, minHeight: "100%",
    }}>
      {/* Title skeleton */}
      <div>
        <GlassShimmerBox width={180} height={16} radius={5} darkMode={darkMode} />
        <GlassShimmerBox width={320} height={11} radius={4} darkMode={darkMode} style={{ marginTop: 6 }} />
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 10 }}>
        {kpiColors.map((kpi, i) => (
          <div key={i} style={{
            ...
            <GlassShimmerBox width={36} height={36} radius={10} darkMode={darkMode} />
            <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
              <GlassShimmerBox width={70} height={9} radius={4} darkMode={darkMode} />
              <GlassShimmerBox width={45} height={22} radius={5} darkMode={darkMode} />
            </div>
          </div>
        ))}
      </div>
      ...
      <div style={{
        ...
        <div style={{ flex: "1 1 200px", display: "flex", flexDirection: "column", gap: 5 }}>
          <GlassShimmerBox width={50} height={8} radius={3} darkMode={darkMode} />
          <GlassShimmerBox width="100%" height={34} radius={10} darkMode={darkMode} />
        </div>
        <div style={{ display: "flex", flexDirection: "column", gap: 5 }}>
          <GlassShimmerBox width={30} height={8} radius={3} darkMode={darkMode} />
          <GlassShimmerBox width={200} height={32} radius={10} darkMode={darkMode} />
        </div>
        <div style={{ display: "flex", flexDirection: "column", gap: 5 }}>
          <GlassShimmerBox width={40} height={8} radius={3} darkMode={darkMode} />
          <GlassShimmerBox width={150} height={32} radius={10} darkMode={darkMode} />
        </div>
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(300px, 1fr))", gap: 12 }}>
        {Array.from({ length: 6 }).map((_, i) => (
          <div key={i} style={{
            ...
            {/* Avatar */}
            <GlassShimmerBox width={46} height={46} radius={999} darkMode={darkMode} />
            {/* Info */}
            <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: 7 }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <GlassShimmerBox width="55%" height={12} radius={4} darkMode={darkMode} />
                <GlassShimmerBox width={65} height={22} radius={8} darkMode={darkMode} />
              </div>
              <GlassShimmerBox width="70%" height={9} radius={4} darkMode={darkMode} />
              <GlassShimmerBox width="45%" height={8} radius={4} darkMode={darkMode} />
              <div style={{ display: "flex", gap: 5, marginTop: 3 }}>
                <GlassShimmerBox width={60} height={18} radius={99} darkMode={darkMode} />
                <GlassShimmerBox width={50} height={18} radius={99} darkMode={darkMode} />
              </div>
            </div>
          </div>
        ))}
...
function UsersView({
  ...
  return (
    <div style={{
      ...
      {/* Title */}
      <div>
        <p style={{ margin: 0, fontSize: "0.95rem", fontWeight: 700, color: ui.textPrimary, letterSpacing: "-0.01em" }}>
          User Management
        </p>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 10 }}>
        {[
          { label: "Total Users", value: users.length, color: FB, bg: darkMode ? "#1a2744" : "#EEF4FF", icon: "👥" },
          { label: "Active", value: activeCount, color: "#36a420", bg: darkMode ? "#0f2e1a" : "#EDFBF3", icon: "🟢" },
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              ...
              <div>
                <p style={{ margin: 0, fontSize: "0.62rem", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.06em", color: s.color, opacity: 0.85 }}>
                  {s.label}
                </p>
                <p style={{ margin: 0, fontSize: "1.4rem", fontWeight: 800, color: s.color, lineHeight: 1.2, letterSpacing: "-0.02em" }}>
                  {s.value}
                </p>
              </div>
            </div>
      ...
      <div style={{
        ...
        <div>
          ...
          <div style={{ ...glassSegment(darkMode), borderRadius: 10, padding: 3, display: "flex", gap: 2, flexWrap: "wrap" }}>
            {allRoles.map((r) => {
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    fontWeight: isAct ? 700 : 500, borderRadius: 7, border: "none",
                    ...(isAct ? glassSegmentActive(darkMode) : { background: "transparent" }),
        ...
        <div>
          ...
          <div style={{ ...glassSegment(darkMode), borderRadius: 10, padding: 3, display: "flex", gap: 2 }}>
            {statuses.map((s) => {
            ...
            <div
              ...
              style={{
                ...
                border: isCurrentlyImpersonating
                  ? `2px solid ${FB}`
                  : (darkMode ? "1.5px solid rgba(255,255,255,0.12)" : "1.5px solid rgba(255,255,255,0.8)"),
            ...
            >
              ...
              <div style={{ padding: "14px 16px 14px", display: "flex", alignItems: "flex-start", gap: 12 }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 6, minWidth: 0, flexWrap: "wrap" }}>
                      ...
                      {isCurrentlyImpersonating && (
                        <span style={{
                          ...
                          background: FB, color: "#fff", letterSpacing: "0.04em", flexShrink: 0,
                        }}>
                          VIEWING
                        </span>
                      )}
                    ...
                    {isCurrentlyImpersonating ? (
                      <button
                        ...
                        style={{
                          ...
                          background: darkMode ? "rgba(46,15,15,0.6)" : "rgba(255,241,242,0.7)",
                          backdropFilter: "blur(8px)",
                      ...
                      <button
                        ...
                        style={{
                          ...
                          background: user.status === "Suspended" ? "transparent" : FB,
                          backdropFilter: "blur(8px)",
                          color: user.status === "Suspended" ? ui.textMuted : "#fff",
                  ...
                  {/* Email */}
                  <p style={{ margin: "2px 0 0", fontSize: "0.72rem", color: ui.textMuted }}>{user.email}</p>

                  {/* Position */}
                  {user.position && (
                    <p style={{ margin: "1px 0 0", fontSize: "0.70rem", color: ui.textMuted, fontStyle: "italic" }}>{user.position}</p>
                  )}
                  ...
                  <div style={{ display: "flex", gap: 5, marginTop: 6, flexWrap: "wrap" }}>
                    <span style={{
                      ...
                      background: darkMode ? `${rc?.darkBg || "#1e2a4a"}cc` : `${rc?.bg || "#dbeafe"}cc`,
                      backdropFilter: "blur(6px)",
                      color: darkMode ? rc?.darkColor || "#93c5fd" : rc?.color || "#1d4ed8",
                    }}>
                      {user.role}
                    </span>
                    <span style={{
                    ...
                    <div style={{ display: "flex", gap: 4, marginTop: 5, flexWrap: "wrap" }}>
                      {user.groups.map((g) => (
                        <span key={g.id} style={{
                          ...
                          background: darkMode ? "rgba(30,39,68,0.7)" : "rgba(224,242,254,0.7)",
                          backdropFilter: "blur(6px)",
      ...
      {filteredUsers.length === 0 && !loading && (
        <div style={{
          ...glass(darkMode, 0.4),
          padding: "40px", textAlign: "center", color: ui.textMuted, fontSize: "0.84rem", borderRadius: 14,
        }}>
          No users found
        </div>
      )}
