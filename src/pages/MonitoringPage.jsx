...
const evaluatorNames = ["Juan dela Cruz","Maria Santos","Pedro Reyes","Ana Gonzales","Jose Bautista","Liza Reyes"];
const USER_ROLE_MAP = {"Juan dela Cruz":"Evaluator","Maria Santos":"QA Officer","Pedro Reyes":"Checker","Ana Gonzales":"Releasing Officer","Jose Bautista":"Decker","Liza Reyes":"Supervisor"};
const DRUG_CATALOG = [{name:"Furacef-750",generic:"Cefuroxime Sodium",rx:"Prescription Drug (RX)"},{name:"Amoxil-500",generic:"Amoxicillin",rx:"Prescription Drug (RX)"},{name:"Calpol-250",generic:"Paracetamol",rx:"Over-the-Counter (OTC)"},{name:"Cloxacil-250",generic:"Cloxacillin",rx:"Prescription Drug (RX)"},{name:"Augmentin-625",generic:"Co-Amoxiclav",rx:"Prescription Drug (RX)"},{name:"Mefenamic-500",generic:"Mefenamic Acid",rx:"Over-the-Counter (OTC)"},{name:"Losartan-50",generic:"Losartan Potassium",rx:"Prescription Drug (RX)"},{name:"Amlodipine-10",generic:"Amlodipine Besylate",rx:"Prescription Drug (RX)"},{name:"Metformin-500",generic:"Metformin HCl",rx:"Prescription Drug (RX)"},{name:"Atorva-20",generic:"Atorvastatin Calcium",rx:"Prescription Drug (RX)"},{name:"Omepra-20",generic:"Omeprazole",rx:"Over-the-Counter (OTC)"},{name:"Salbu-4",generic:"Salbutamol Sulfate",rx:"Prescription Drug (RX)"},{name:"Cetirizine-10",generic:"Cetirizine HCl",rx:"Over-the-Counter (OTC)"},{name:"Azithro-500",generic:"Azithromycin",rx:"Prescription Drug (RX)"},{name:"Cipro-500",generic:"Ciprofloxacin HCl",rx:"Prescription Drug (RX)"},{name:"Ibupro-400",generic:"Ibuprofen",rx:"Over-the-Counter (OTC)"},{name:"Doxy-100",generic:"Doxycycline Hyclate",rx:"Prescription Drug (RX)"},{name:"Prevnar-13",generic:"Pneumococcal Vaccine",rx:"Vaccine"},{name:"Fluvax-QIV",generic:"Influenza Vaccine",rx:"Vaccine"},{name:"Engerix-B",generic:"Hepatitis B Vaccine",rx:"Vaccine"},{name:"Typhim-Vi",generic:"Typhoid Vaccine",rx:"Vaccine"},{name:"Prednisone-20",generic:"Prednisone",rx:"Prescription Drug (RX)"},{name:"Levoflox-500",generic:"Levofloxacin",rx:"Prescription Drug (RX)"},{name:"MMR-II",generic:"MMR Vaccine",rx:"Vaccine"}];
...
const yearlyMix = {2022:{approved:38,disapproved:22,onProcess:15},2023:{approved:45,disapproved:18,onProcess:20},2024:{approved:52,disapproved:25,onProcess:18},2025:{approved:60,disapproved:30,onProcess:25},2026:{approved:20,disapproved:8,onProcess:30}};
const ACTIVITY_FEED = [{id:1,user:"Maria Santos",action:"completed evaluation",target:"Amoxil-500 (Amoxicillin)",time:"2 min ago",icon:"✅",color:"#36a420"},{id:2,user:"Juan dela Cruz",action:"flagged for compliance",target:"Furacef-750 (Cefuroxime Sodium)",time:"14 min ago",icon:"🚩",color:"#f59e0b"},{id:3,user:"Pedro Reyes",action:"submitted for QA",target:"Prevnar-13 (Pneumococcal Vaccine)",time:"32 min ago",icon:"🔍",color:FB},{id:4,user:"Ana Gonzales",action:"disapproved application",target:"Cipro-500 (Ciprofloxacin HCl)",time:"1 hr ago",icon:"❌",color:"#e02020"},{id:5,user:"Jose Bautista",action:"started evaluation",target:"Metformin-500 (Metformin HCl)",time:"1 hr ago",icon:"▶️",color:"#9333ea"},{id:6,user:"Liza Reyes",action:"released document",target:"Calpol-250 (Paracetamol)",time:"2 hr ago",icon:"📤",color:"#36a420"},{id:7,user:"Maria Santos",action:"started evaluation",target:"Losartan-50 (Losartan Potassium)",time:"3 hr ago",icon:"▶️",color:"#9333ea"},{id:8,user:"Pedro Reyes",action:"completed evaluation",target:"MMR-II (MMR Vaccine)",time:"4 hr ago",icon:"✅",color:"#36a420"}];
const DEADLINES = [{dtn:"20260308091422",drug:"Furacef-750 (Cefuroxime Sodium)",evaluator:"Maria Santos",deadline:"2026-03-13",step:"For QA",urgency:"critical"},{dtn:"20260308092137",drug:"Augmentin-625 (Co-Amoxiclav)",evaluator:"Juan dela Cruz",deadline:"2026-03-13",step:"For Checking",urgency:"critical"},{dtn:"20260307103045",drug:"Prevnar-13 (Pneumococcal Vaccine)",evaluator:"Pedro Reyes",deadline:"2026-03-14",step:"For Compliance",urgency:"warning"},{dtn:"20260306085512",drug:"Metformin-500 (Metformin HCl)",evaluator:"Jose Bautista",deadline:"2026-03-14",step:"For Evaluation",urgency:"warning"},{dtn:"20260305112233",drug:"Losartan-50 (Losartan Potassium)",evaluator:"Ana Gonzales",deadline:"2026-03-17",step:"For QA",urgency:"normal"},{dtn:"20260304094501",drug:"Amlodipine-10 (Amlodipine Besylate)",evaluator:"Liza Reyes",deadline:"2026-03-18",step:"For Releasing",urgency:"normal"}];
const COMPLIANCE_FLAGS = [{dtn:"20260301091234",drug:"Cipro-500 (Ciprofloxacin HCl)",evaluator:"Ana Gonzales",reason:"Incomplete documentary requirements",severity:"high",flaggedDate:"2026-03-01"},{dtn:"20260302103344",drug:"Doxy-100 (Doxycycline Hyclate)",evaluator:"Juan dela Cruz",reason:"Missing GMP certificate",severity:"high",flaggedDate:"2026-03-02"},{dtn:"20260305084521",drug:"Salbu-4 (Salbutamol Sulfate)",evaluator:"Pedro Reyes",reason:"Label discrepancy noted",severity:"medium",flaggedDate:"2026-03-05"},{dtn:"20260307091100",drug:"Ibupro-400 (Ibuprofen)",evaluator:"Maria Santos",reason:"Clinical data update required",severity:"medium",flaggedDate:"2026-03-07"},{dtn:"20260309095500",drug:"Omepra-20 (Omeprazole)",evaluator:"Liza Reyes",reason:"Bioequivalence study pending",severity:"low",flaggedDate:"2026-03-09"}];
const WORKLOAD_DATA = {"Juan dela Cruz":[2,7,4,0,6,5,8,1,6,7,0,5,8,3,4,7,1,8,5,0],"Maria Santos":[6,0,8,4,7,7,0,6,8,2,5,7,0,6,8,0,6,3,7,5],"Pedro Reyes":[0,6,2,7,5,4,6,0,5,7,8,2,7,0,1,7,3,0,6,4],"Ana Gonzales":[5,0,6,8,2,6,2,7,0,8,1,6,0,7,5,3,7,6,0,6],"Jose Bautista":[7,1,0,6,2,0,7,5,2,6,7,0,6,3,1,0,5,7,6,2],"Liza Reyes":[2,6,0,5,7,6,0,5,7,1,3,7,2,6,0,6,0,5,2,7]};
const USER_DATABASE = [{id:1,name:"Juan dela Cruz",email:"jdelacruz@pba.gov.ph",role:"Evaluator",status:"Active",lastLogin:"Today, 9:14 AM",avatar:0,tasks:72,approved:45,specialization:"Prescription Drug (RX)"},{id:2,name:"Maria Santos",email:"msantos@pba.gov.ph",role:"QA Officer",status:"Active",lastLogin:"Today, 8:50 AM",avatar:1,tasks:68,approved:50,specialization:"Prescription Drug (RX)"},{id:3,name:"Pedro Reyes",email:"preyes@pba.gov.ph",role:"Checker",status:"Active",lastLogin:"Yesterday, 4:22 PM",avatar:2,tasks:54,approved:38,specialization:"Vaccine"},{id:4,name:"Ana Gonzales",email:"agonzales@pba.gov.ph",role:"Releasing Officer",status:"Active",lastLogin:"Today, 10:05 AM",avatar:3,tasks:60,approved:42,specialization:"Over-the-Counter (OTC)"},{id:5,name:"Jose Bautista",email:"jbautista@pba.gov.ph",role:"Decker",status:"Inactive",lastLogin:"Mar 8, 2026",avatar:4,tasks:48,approved:30,specialization:"Prescription Drug (RX)"},{id:6,name:"Liza Reyes",email:"lreyes@pba.gov.ph",role:"Supervisor",status:"Active",lastLogin:"Today, 11:30 AM",avatar:5,tasks:55,approved:40,specialization:"Over-the-Counter (OTC)"},{id:7,name:"Carlo Mendoza",email:"cmendoza@pba.gov.ph",role:"Director",status:"Active",lastLogin:"Today, 7:45 AM",avatar:6,tasks:0,approved:0,specialization:"All Types"},{id:8,name:"Rosa Villanueva",email:"rvillanueva@pba.gov.ph",role:"Compliance Officer",status:"Active",lastLogin:"Today, 9:00 AM",avatar:7,tasks:0,approved:0,specialization:"Compliance"},{id:9,name:"Dante Flores",email:"dflores@pba.gov.ph",role:"Admin",status:"Active",lastLogin:"Today, 8:00 AM",avatar:0,tasks:0,approved:0,specialization:"System Admin"},{id:10,name:"Nena Cruz",email:"ncruz@pba.gov.ph",role:"Checker",status:"Suspended",lastLogin:"Feb 28, 2026",avatar:1,tasks:20,approved:10,specialization:"Vaccine"}];
const avatarPalette = [{bg:"#dbeafe",color:"#1d4ed8"},{bg:"#fce7f3",color:"#be185d"},{bg:"#d1fae5",color:"#065f46"},{bg:"#fef3c7",color:"#92400e"},{bg:"#ede9fe",color:"#5b21b6"},{bg:"#fee2e2",color:"#991b1b"},{bg:"#cffafe",color:"#0e7490"},{bg:"#fef9c3",color:"#713f12"}];
const statusColorsDark = {Approved:{bg:"#0a2e1a",color:"#4ade80"},Disapproved:{bg:"#2e0a0a",color:"#f87171"},"On Process":{bg:"#2a2000",color:"#fde68a"}};
const timelineColorsDark = {Within:{bg:"#0a2e1a",color:"#4ade80"},Beyond:{bg:"#2e0a0a",color:"#f87171"}};
const statusColors = {Approved:{bg:"#dcfce7",color:"#15803d"},Disapproved:{bg:"#fef2f2",color:"#b91c1c"},"On Process":{bg:"#fef9c3",color:"#a16207"}};
const timelineColors = {Within:{bg:"#dcfce7",color:"#15803d"},Beyond:{bg:"#fef2f2",color:"#b91c1c"}};
const stepColors = {"For Evaluation":{bg:"#dbeafe",color:"#1d4ed8"},"For Compliance":{bg:"#fef9c3",color:"#a16207"},"For Checking":{bg:"#dcfce7",color:"#15803d"},"For QA":{bg:"#f3e8ff",color:"#7e22ce"},"For Releasing":{bg:"#ffedd5",color:"#c2410c"}};
const stepColorsDark = {"For Evaluation":{bg:"#1e2a4a",color:"#93c5fd"},"For Compliance":{bg:"#2a2000",color:"#fde68a"},"For Checking":{bg:"#0a2e1a",color:"#86efac"},"For QA":{bg:"#2a1a3e",color:"#d8b4fe"},"For Releasing":{bg:"#2e1500",color:"#fed7aa"}};
const rxColors = {"Over-the-Counter (OTC)":{bg:"#e0f2fe",color:"#0369a1"},Vaccine:{bg:"#dcfce7",color:"#15803d"},"Prescription Drug (RX)":{bg:"#fef3c7",color:"#b45309"}};
const rxColorsDark = {"Over-the-Counter (OTC)":{bg:"#0c2a3a",color:"#38bdf8"},Vaccine:{bg:"#0a2e1a",color:"#4ade80"},"Prescription Drug (RX)":{bg:"#2e1f00",color:"#fbbf24"}};
...
function generateData() {
  ...
  Object.entries(yearlyMix).forEach(([yearStr, mix]) => {
    ...
    for (let i = 0; i < total; i++) {
      ...
      rows.push({date:`${year}-${mm}-${dd}`,evaluator:evaluatorNames[i % evaluatorNames.length],dtn:makeDTN(year,month,day,seq),drugName:`${drug.name} (${drug.generic})`,appStep:appSteps[i % appSteps.length],timeline:timelineOptions[i % 2],status,prescription:drug.rx,mfrCountry:MFR_COUNTRIES[(i*2+seq)%MFR_COUNTRIES.length],traderCountry:TRADER_COUNTRIES[(i*3+seq)%TRADER_COUNTRIES.length],importerCountry:IMPORTER_COUNTRIES[(i*5+seq)%IMPORTER_COUNTRIES.length],distributorCountry:DISTRIBUTOR_COUNTRIES[(i*7+seq)%DISTRIBUTOR_COUNTRIES.length],repackerCountry:REPACKER_COUNTRIES[(i*11+seq)%REPACKER_COUNTRIES.length]});
      seq++;
    }
  });
  return rows;
...
function ChartDetailModal({ title, subtitle, rows, darkMode, onClose, ui }) {
  ...
  const filtered = useMemo(() => {
    ...
    return rows.filter((r) => r.dtn.toLowerCase().includes(q) || r.evaluator.toLowerCase().includes(q) || (r.drugName||"").toLowerCase().includes(q) || r.status.toLowerCase().includes(q) || r.prescription.toLowerCase().includes(q) || r.appStep.toLowerCase().includes(q));
  }, [rows, search]);
...
function NavItem({ icon, label, active, onClick, ui }) {
  ...
  return (
    <div onClick={onClick} onMouseEnter={()=>setHov(true)} onMouseLeave={()=>setHov(false)} style={{display:"flex",alignItems:"center",gap:6,padding:"6px 10px",borderRadius:8,margin:"2px 8px",background:active?ui.activeNavBg:hov?ui.hoverBg:"transparent",cursor:"pointer",transition:"background 0.12s"}}>
      <span style={{width:20,height:20,borderRadius:"50%",background:active?FB:ui.inputBg,display:"flex",alignItems:"center",justifyContent:"center",fontSize:"1.1rem",flexShrink:0,transition:"background 0.15s"}}>{icon}</span>
      <span style={{flex:1,fontSize:"0.75rem",fontWeight:active?500:400,color:active?FB:ui.textPrimary}}>{label}</span>
    </div>
  );
}
...
function MonitoringPage({ darkMode }) {
  ...
  const chartFiltered = useMemo(() => tableData.filter((row)=>{const d=new Date(row.date+"T00:00:00");if(chartYear!=="All"&&d.getFullYear()!==Number(chartYear))return false;if(chartMonth!=="All"&&d.getMonth()!==Number(chartMonth))return false;if(rxFilter!=="All"&&row.prescription!==rxFilter)return false;return true;}),[tableData,chartYear,chartMonth,rxFilter]);
  ...
  const modalTasks = useMemo(() => {
    ...
    return [...f].sort((a, b) => {
      ...
      if (modalSortCol === "date") { av = new Date(av + "T00:00:00"); bv = new Date(bv + "T00:00:00"); } else { av = String(av).toLowerCase(); bv = String(bv).toLowerCase(); }
  ...
  const MainContent = () => {
    switch (activeNav) {
      case "overview": return <OverviewView {...sharedProps} USER_ROLE_MAP={USER_ROLE_MAP} ACTIVITY_FEED={ACTIVITY_FEED} DEADLINES={DEADLINES} COMPLIANCE_FLAGS={COMPLIANCE_FLAGS} setActiveNav={setActiveNav} setModalEval={setModalEval} />;
      case "records": return <RecordsView {...sharedProps} setModalEval={setModalEval} />;
      case "analytics": return <AnalyticsView {...sharedProps} availableYears={availableYears} chartYear={chartYear} setChartYear={setChartYear} chartMonth={chartMonth} setChartMonth={setChartMonth} rxFilter={rxFilter} setRxFilter={setRxFilter} onSliceClick={handleSliceClick} />;
      case "deadlines": return <DeadlinesView ui={ui} darkMode={darkMode} DEADLINES={DEADLINES} USER_ROLE_MAP={USER_ROLE_MAP} />;
      case "compliance": return <ComplianceView ui={ui} darkMode={darkMode} COMPLIANCE_FLAGS={COMPLIANCE_FLAGS} USER_ROLE_MAP={USER_ROLE_MAP} />;
      case "workload": return <WorkloadView ui={ui} darkMode={darkMode} currentEvaluators={currentEvaluators} workloadData={WORKLOAD_DATA} uniqueEvaluators={uniqueEvaluators} />;
      case "activity": return <ActivityFeedView ui={ui} darkMode={darkMode} activitySearch={activitySearch} setActivitySearch={setActivitySearch} />;
      case "users": return <UsersView ui={ui} darkMode={darkMode} userDatabase={USER_DATABASE} impersonating={impersonating} setImpersonating={setImpersonating} setShowImpersonateConfirm={setShowImpersonateConfirm} tableData={tableData} />;
      default: return null;
    }
  };
    ...
    <>
      ...
      <div style={{display:"flex",flexDirection:"column",width:"100%",height:"100%",overflow:"hidden",fontFamily:font}}>
        <div className="mon-scroll" style={{display:"flex",flex:"1 1 0",minHeight:0,overflowY:"scroll",overflowX:"hidden"}}>
          {!isMobile && (
            <div style={{flexShrink:0,width:200,position:"sticky",top:0,alignSelf:"stretch",maxHeight:"100vh",overflowY:"auto"}}>
              <div style={{width:"100%",height:"100%",minHeight:"100%",background:ui.sidebarBg,borderRight:`1px solid ${ui.cardBorder}`,display:"flex",flexDirection:"column"}}>
                <div style={{padding:"16px 10px 10px"}}>
                  <p style={{fontSize:"0.68rem",fontWeight:700,color:ui.textMuted,textTransform:"uppercase",letterSpacing:"0.07em",margin:"0 0 10px 6px"}}>Monitoring</p>
                  {navItems.map(({key,...rest})=>(<NavItem key={key} {...rest} active={activeNav===key} onClick={()=>setActiveNav(key)} ui={ui} />))}
                </div>
              </div>
            </div>
          )}

          <div style={{flex:1,minWidth:0,padding:isMobile?"10px":"14px",paddingBottom:100,boxSizing:"border-box"}}>
            ...
            {impersonating && (
              <div style={{marginBottom:14,padding:"10px 16px",borderRadius:10,background:darkMode?"#1a2744":"#e7f0fd",border:`1.5px solid ${FB}`,display:"flex",alignItems:"center",gap:12}}>
                ...
                <button
                  ...
                  style={{padding:"5px 12px",fontSize:"0.75rem",fontWeight:700,borderRadius:7,border:"1.5px solid #e02020",background:darkMode?"#2e0f0f":"#fff1f2",color:"#e02020",cursor:"pointer",fontFamily:font,flexShrink:0}}
                >
                  ✕ Stop Impersonation
                </button>
              </div>
            ...
            {isMobile && (
              <div style={{display:"flex",gap:6,marginBottom:14,overflowX:"auto",paddingBottom:2}}>
                {navItems.map((n)=>(
                  <button key={n.key} onClick={()=>setActiveNav(n.key)} style={{padding:"6px 14px",borderRadius:99,border:`1px solid ${activeNav===n.key?FB:ui.cardBorder}`,background:activeNav===n.key?`${FB}12`:"transparent",color:activeNav===n.key?FB:ui.textMuted,fontSize:"0.78rem",fontWeight:activeNav===n.key?700:500,cursor:"pointer",whiteSpace:"nowrap",fontFamily:font}}>
                    {n.icon} {n.label}
                  </button>
                ))}
              </div>
        ...
        <div onClick={handleModalClose} style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.5)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:1000,backdropFilter:"blur(4px)"}}>
          <div onClick={(e)=>e.stopPropagation()} style={{background:ui.cardBg,border:`1px solid ${ui.cardBorder}`,borderRadius:12,overflow:"hidden",width:920,maxWidth:"95vw",boxShadow:"0 20px 60px rgba(0,0,0,0.25)",display:"flex",flexDirection:"column",maxHeight:"85vh"}}>
            <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"14px 20px",borderBottom:`1px solid ${ui.divider}`,background:colHdr,flexShrink:0}}>
              {(()=>{const av=getAvatarColor(modalEval,uniqueEvaluators);const role=USER_ROLE_MAP[modalEval]||"User";return(
            ...
            <div style={{overflowY:"auto",overflowX:"auto",flex:1}}>
              <div style={{minWidth:700}}>
                <div style={{display:"flex",gap:10,alignItems:"flex-end",padding:"10px 14px",borderBottom:`1px solid ${ui.divider}`,background:colHdr,flexWrap:"wrap"}}>
                  ...
                  {(modalDateFrom||modalDateTo)&&(<button onClick={()=>{setModalDateFrom("");setModalDateTo("");}} style={{padding:"6px 12px",fontSize:"0.78rem",borderRadius:6,border:`1px solid ${ui.cardBorder}`,background:"transparent",color:ui.textMuted,cursor:"pointer",fontFamily:font}}>Reset</button>)}
                </div>
                <div style={{padding:"10px 14px",borderBottom:`1px solid ${ui.divider}`,background:colHdr,display:"flex",gap:6,alignItems:"center",flexWrap:"wrap"}}>
                  {[{key:"All",label:"All",color:FB},{key:"On Process",label:"⏳ On Process",color:"#f59e0b"},{key:"Approved",label:"✅ Approved",color:"#36a420"},{key:"Disapproved",label:"❌ Disapproved",color:"#e02020"}].map(({key,label,color})=>{
                    ...
                    return(<button key={key} onClick={()=>setModalStatusTab(key)} style={{padding:"5px 14px",fontSize:"0.76rem",fontWeight:isAct?700:500,borderRadius:99,border:`1.5px solid ${isAct?color:ui.cardBorder}`,background:isAct?`${color}15`:"transparent",color:isAct?color:ui.textMuted,cursor:"pointer",fontFamily:font,display:"flex",alignItems:"center",gap:5,transition:"all 0.15s"}}>
                ...
                <div style={{display:"grid",gridTemplateColumns:"1.5fr 1fr 2fr 1.1fr 1fr 0.9fr 60px",background:colHdr,borderBottom:`1px solid ${ui.divider}`,position:"sticky",top:0,zIndex:2}}>
                  {[{label:"DTN",col:"dtn"},{label:"Date",col:"date"},{label:"Drug / Application",col:"drugName"},{label:"App Step",col:"appStep"},{label:"Timeline",col:"timeline"},{label:"Status",col:"status"}].map(({label,col})=>(
                    <span key={col} onClick={()=>toggleModalSort(col)} style={{fontSize:"0.67rem",fontWeight:700,textTransform:"uppercase",letterSpacing:"0.07em",color:modalSortCol===col?FB:ui.textMuted,padding:"8px 14px",textAlign:"center",cursor:"pointer",userSelect:"none",display:"flex",alignItems:"center",justifyContent:"center"}}>{label}<SortArrow col={col} /></span>
                  ))}
                ...
                {modalTasks.length===0?(<div style={{padding:"24px",textAlign:"center",color:ui.textMuted,fontSize:"0.84rem"}}>No tasks found</div>):(
      ...
      {/* Chart Detail Modal */}
      {chartModal && <ChartDetailModal title={chartModal.title} subtitle={chartModal.subtitle} rows={chartModal.rows} darkMode={darkMode} onClose={()=>setChartModal(null)} ui={ui} />}

      {/* Reassign Modal */}
      {reassignTask && <ReassignModal task={reassignTask} evaluators={uniqueEvaluators} darkMode={darkMode} onClose={()=>setReassignTask(null)} onConfirm={handleReassignConfirm} ui={ui} />}
          ...
          <div onClick={(e)=>e.stopPropagation()} style={{background:ui.cardBg,border:`1px solid ${ui.cardBorder}`,borderRadius:14,overflow:"hidden",width:400,maxWidth:"92vw",boxShadow:"0 24px 60px rgba(0,0,0,0.3)"}}>
            ...
            <div style={{padding:"16px 20px",display:"flex",justifyContent:"flex-end",gap:8}}>
              ...
              <button
                ...
                style={{padding:"8px 18px",fontSize:"0.82rem",fontWeight:700,borderRadius:7,border:"none",background:FB,color:"#fff",cursor:"pointer",fontFamily:font}}
              >
                👁 View Dashboard
              </button>
            </div>
