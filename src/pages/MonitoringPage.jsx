...
function MonitoringPage({ darkMode }) {
  ...
  const NavIcons = {
    overview: () => (
      ...
      >
        <path
          ...
          fill="#fed7aa"
        />
        <polyline points="9 22 9 12 15 12 15 22" stroke="#ea580c" />
      </svg>
    ),
    records: () => (
      <svg
      ...
      >
        <path
          ...
          fill="#dbeafe"
        />
        <polyline points="14 2 14 8 20 8" stroke="#2563eb" />
        <line x1="16" y1="13" x2="8" y2="13" stroke="#60a5fa" />
    ...
    analytics: () => (
      ...
      >
        ...
        <line x1="12" y1="20" x2="12" y2="4" stroke="#6366f1" />
    ...
    deadlines: () => (
      <svg
        ...
        strokeLinejoin="round"
      >
        <circle cx="12" cy="12" r="10" stroke="#ec4899" fill="#fce7f3" />
        <polyline points="12 6 12 12 16 14" stroke="#db2777" />
      </svg>
    ),
    compliance: () => (
      <svg
      ...
      >
        <path
          ...
          fill="#ccfbf1"
        />
        <polyline points="9 12 11 14 15 10" stroke="#0d9488" />
      </svg>
    ),
    workload: () => (
      <svg
        ...
        strokeLinejoin="round"
      >
        <path d="M22 12h-4l-3 9L9 3l-3 9H2" stroke="#ef4444" />
        <circle cx="9" cy="12" r="1.5" fill="#fca5a5" />
        <circle cx="15" cy="12" r="1.5" fill="#fca5a5" />
      </svg>
    ),
    activity: () => (
      <svg
        ...
        strokeLinejoin="round"
      >
        <circle cx="12" cy="12" r="10" stroke="#8b5cf6" fill="#ede9fe" />
        <circle cx="12" cy="12" r="4" stroke="#7c3aed" fill="#c4b5fd" />
    ...
    users: () => (
      <svg
        ...
        strokeLinejoin="round"
      >
        <circle cx="9" cy="7" r="4" stroke="#0ea5e9" fill="#e0f2fe" />
        <path
          d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"
          stroke="#0284c7"
          fill="#bae6fd"
        />
        <circle cx="17" cy="7" r="3" stroke="#06b6d4" fill="#cffafe" />
        <path d="M21 21v-2a3 3 0 0 0-3-3h-1" stroke="#0891b2" />
      </svg>
    ),
    frptat: () => (
      <svg
      ...
      >
        ...
        <polyline points="12 6 12 12 8 14" stroke="#d97706" />
        <path d="M17 4l2 2" stroke="#f59e0b" />
  ...
  const navItems = [
    ...
    {
      key: "frpmonitoring",
      label: "FRP and CRP Monitoring",
      subtitle: "Overview & Breakdowns",
    },
    {
      key: "processingtrend",
